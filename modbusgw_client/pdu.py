"""Client-side Modbus PDU definitions mirrored from the gateway."""
...
_OPERATION_MAP = {fc: 'read' for fc in _OP_READ}
_OPERATION_MAP.update({fc: 'write' for fc in _OP_WRITE})
